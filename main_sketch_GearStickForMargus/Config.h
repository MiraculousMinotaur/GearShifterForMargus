...
#define MCP_GEAR_SIXWAY_FIRST_PIN 10   // MCP pins 0-5 for six-way switches (GPB2-GPB7)
#define MCP_GEAR_MODE_FIRST_PIN 0       // MCP pins 6-7 for mode switches (GPA0-GPA1)
#define MCP_GEAR_IMPULSE_FIRST_PIN 6   // MCP pins 8-9 for impulse switches (GPA6-GPA7)
